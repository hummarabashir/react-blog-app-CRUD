...
const DisplayAllPosts = () => {
  ...
  const [allPosts, setAllPosts] = useState([
    {
      id: 1,
      title: "DIPLOMATIC MOM: My journey as a Foreign Service Officer, wife and mom",
      content:
  ...
  if (isCreateNewPost) {
    ...
    return (
      <>
        ...
        />
        <button className="btn btn-danger cancel-update-button" onClick={toggleModifyPostComponent} >
          Cancel
        </button>
      </>
    );
